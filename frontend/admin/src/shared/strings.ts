...
export const strings = {
  ...
  wallets: {
    ...
    subtitle: "Where customer payments land — one address per rail we accept.",
    accepting: "Accepting",
    notAccepting: "Supported, not configured",
    notAcceptingHint: "No receiving address set, so these coins are not offered at checkout.",
    ...
    configError: "ONCHAIN_METHODS could not be read",
    noneTitle: "No rails configured",
    noneHint: "Set ONCHAIN_METHODS in the deploy environment to start accepting crypto.",
  },
  dashboard: {
