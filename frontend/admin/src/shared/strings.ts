...
export const strings = {
  ...
  pools: {
    ...
    filterInIproxy: "In iProxy",
    filterAbsent: "Not in iProxy",
    absentBadge: "Not in iProxy",
    absentHint: "Removed from the iproxy account — kept because orders point at it.",
  ...
  invoices: {
    ...
    searchPlaceholder: "Search order number, client, receiving address…",
    empty: "No invoices yet",
    emptyFiltered: "No invoices match these filters",
    emptyFilteredHint: "Clear a filter, or widen the date range.",
  },

  ledger: {
    title: "Payments",
    subtitle: "What arrived on-chain, and what is still owed.",
  ...
  referrals: {
    ...
    ledger: "Ledger",
    payoutViewOpen: "Awaiting action",
  ...
  promos: {
    title: "Promo codes",
    subtitle:
      "A percentage off the price at checkout. Each code carries its own discount, the dates it works between, and how many times it can be spent.",
    create: "New code",
    // Said once at the top because neither rule is visible in any field below, and both
    // are the ones an operator gets wrong: a 50-use code is not 50 uses for one client,
    // and a partner earns on what was actually paid, not on the sticker price.
    banner:
      "A client can use any one code once, whatever its limit says. Referral commission is worked out on the discounted total.",
    code: "Code",
    codeHint: "What the client types. Capitals do not matter.",
    percentOff: "Discount %",
    startsAt: "Starts",
    startsAtHint: "Empty — works from now.",
    expiresAt: "Expires",
    expiresAtHint: "Empty — never expires. The code still works all through the day you pick.",
    maxUses: "Uses allowed",
    maxUsesHint: "1 for one person, 50 for a campaign, empty for unlimited.",
    appliesTo: "Applies to",
    appliesToAny: "Purchases and extensions",
    appliesToPurchase: "New purchases only",
    note: "Note",
    noteHint: "For you, not the client — who you gave it to, which campaign it belongs to.",
    colWindow: "Valid",
    colUses: "Used",
    colState: "State",
    unlimited: "Unlimited",
    ...
    emptyHint: "A code gives a percentage off at checkout. Create one and hand it to a client.",
    deleteTitle: "Delete promo code",
    deleteConfirm: "Delete",
    created: "Promo code created",
    deleted: "Promo code deleted",
    usageTitle: "Who has used them",
    usageHint:
      "Every order that carried a code, including ones that were cancelled or never paid — the code goes back to the client when that happens, and this is where you see it happened at all.",
    usageAll: "All codes",
    usageEmpty: "Nobody has used a code yet",
    colWhen: "When",
    colClient: "Client",
    colOrder: "Order",
    colPlan: "Plan",
