...
export const strings = {
  ...
  locations: {
    title: "Cities",
    subtitle: "Cities available to sell proxies under, and the order they list in the mini-app.",
    create: "New city",
    edit: "Edit city",
    city: "City",
    stateCode: "State",
    stateCodeHint: "Two-letter USPS code, e.g. WI",
    connectionsCount: "Connections",
    sortOrder: "Sort order",
    sortOrderHint: "Lower numbers list first",
    active: "Active",
